...
class RestaurantModel(BaseModel):
    ...
    rest_id: Any = Field(None, description="餐厅id（根据中文名hash后生成，唯一）")
    rest_belonged_cp: Any = Field(None, description="所属CP（必须有）")
    ...
    rest_location: Any = Field(None, description="餐厅的经纬度，格式为 '纬度,经度'（例如 '39.9042,116.4074'）")
    rest_distance: Any = Field(None, description="与所属CP的距离（单位为km）")
